...
`,`getStyles`);function R(e,t){let n=se(e),r=n.filter(t=>oe(t,e)),i=0,a=0,o=[];if(r.length>1){let t=le(r);for(let e=0;e<r.length;++e){let n=r[e];n.angle=Math.atan2(n.x-t.x,n.y-t.y)}r.sort((e,t)=>t.angle-e.angle);let n=r[r.length-1];for(let t=0;t<r.length;++t){let s=r[t];a+=(n.x+s.x)*(s.y-n.y);let c={x:(s.x+n.x)/2,y:(s.y+n.y)/2},l=null;for(let t=0;t<s.parentIndex.length;++t)if(n.parentIndex.includes(s.parentIndex[t])){let r=e[s.parentIndex[t]],i=Math.atan2(s.x-r.x,s.y-r.y),a=Math.atan2(n.x-r.x,n.y-r.y),o=a-i;o<0&&(o+=2*Math.PI);let u=a-o/2,d=B(c,{x:r.x+r.radius*Math.sin(u),y:r.y+r.radius*Math.cos(u)});d>r.radius*2&&(d=r.radius*2),(l==null||l.width>d)&&(l={circle:r,width:d,p1:s,p2:n,large:d>r.radius,sweep:!0})}l!=null&&(o.push(l),i+=z(l.circle.radius,l.width),n=s)}}else{let t=e[0];for(let n=1;n<e.length;++n)e[n].radius<t.radius&&(t=e[n]);let n=!1;for(let r=0;r<e.length;++r)if(B(e[r],t)>Math.abs(t.radius-e[r].radius)){n=!0;break}n?i=a=0:(i=t.radius*t.radius*Math.PI,o.push({circle:t,p1:{x:t.x,y:t.y+t.radius},p2:{x:t.x-1e-10,y:t.y+t.radius},width:t.radius*2,large:!0,sweep:!0}))}return a/=2,t&&(t.area=i+a,t.arcArea=i,t.polygonArea=a,t.arcs=o,t.innerPoints=r,t.intersectionPoints=n),i+a}m(R,`intersectionArea`);function oe(e,t){return t.every(t=>B(e,t)<t.radius+1e-10)}m(oe,`containedInCircles`);function se(e){let t=[];for(let n=0;n<e.length;++n)for(let r=n+1;r<e.length;++r){let i=ce(e[n],e[r]);for(let e of i)e.parentIndex=[n,r],t.push(e)}return t}m(se,`getIntersectionPoints`);function z(e,t){return e*e*Math.acos(1-t/e)-(e-t)*Math.sqrt(t*(2*e-t))}m(z,`circleArea`);function B(e,t){return Math.sqrt((e.x-t.x)*(e.x-t.x)+(e.y-t.y)*(e.y-t.y))}m(B,`distance`);function V(e,t,n){if(n>=e+t)return 0;if(n<=Math.abs(e-t))return Math.PI*Math.min(e,t)*Math.min(e,t);let r=e-(n*n-t*t+e*e)/(2*n),i=t-(n*n-e*e+t*t)/(2*n);return z(e,r)+z(t,i)}m(V,`circleOverlap`);function ce(e,t){let n=B(e,t),r=e.radius,i=t.radius;if(n>=r+i||n<=Math.abs(r-i))return[];let a=(r*r-i*i+n*n)/(2*n),o=Math.sqrt(r*r-a*a),s=e.x+a*(t.x-e.x)/n,c=e.y+a*(t.y-e.y)/n,l=-(t.y-e.y)*(o/n),u=-(t.x-e.x)*(o/n);return[{x:s+l,y:c-u},{x:s-l,y:c+u}]}m(ce,`circleCircleIntersection`);function le(e){let t={x:0,y:0};for(let n of e)t.x+=n.x,t.y+=n.y;return t.x/=e.length,t.y/=e.length,t}m(le,`getCenter`);function ue(e,t,n,r){r||={};let i=r.maxIterations||100,a=r.tolerance||1e-10,o=e(t),s=e(n),c=n-t;if(o*s>0)throw`Initial bisect points must have opposite signs`;if(o===0)return t;if(s===0)return n;for(let n=0;n<i;++n){c/=2;let n=t+c,r=e(n);if(r*o>=0&&(t=n),Math.abs(c)<a||r===0)return n}return t+c}m(ue,`bisect`);function H(e){let t=Array(e);for(let n=0;n<e;++n)t[n]=0;return t}m(H,`zeros`);function de(e,t){return H(e).map(()=>H(t))}m(de,`zerosM`);function U(e,t){let n=0;for(let r=0;r<e.length;++r)n+=e[r]*t[r];return n}m(U,`dot`);function W(e){return Math.sqrt(U(e,e))}m(W,`norm2`);function G(e,t,n){for(let r=0;r<t.length;++r)e[r]=t[r]*n}m(G,`scale`);function K(e,t,n,r,i){for(let a=0;a<e.length;++a)e[a]=t*n[a]+r*i[a]}m(K,`weightedSum`);function fe(e,t,n){n||={};let r=n.maxIterations||t.length*200,i=n.nonZeroDelta||1.05,a=n.zeroDelta||.001,o=n.minErrorDelta||1e-6,s=n.minErrorDelta||1e-5,c=n.rho===void 0?1:n.rho,l=n.chi===void 0?2:n.chi,u=n.psi===void 0?-.5:n.psi,d=n.sigma===void 0?.5:n.sigma,f,p=t.length,h=Array(p+1);h[0]=t,h[0].fx=e(t),h[0].id=0;for(let n=0;n<p;++n){let r=t.slice();r[n]=r[n]?r[n]*i:a,h[n+1]=r,h[n+1].fx=e(r),h[n+1].id=n+1}function g(e){for(let t=0;t<e.length;t++)h[p][t]=e[t];h[p].fx=e.fx}m(g,`updateSimplex`);let _=m((e,t)=>e.fx-t.fx,`sortOrder`),v=t.slice(),y=t.slice(),b=t.slice(),x=t.slice();for(let t=0;t<r;++t){if(h.sort(_),n.history){let e=h.map(e=>{let t=e.slice();return t.fx=e.fx,t.id=e.id,t});e.sort((e,t)=>e.id-t.id),n.history.push({x:h[0].slice(),fx:h[0].fx,simplex:e})}f=0;for(let e=0;e<p;++e)f=Math.max(f,Math.abs(h[0][e]-h[1][e]));if(Math.abs(h[0].fx-h[p].fx)<o&&f<s)break;for(let e=0;e<p;++e){v[e]=0;for(let t=0;t<p;++t)v[e]+=h[t][e];v[e]/=p}let t=h[p];if(K(y,1+c,v,-c,t),y.fx=e(y),y.fx<h[0].fx)K(x,1+l,v,-l,t),x.fx=e(x),x.fx<y.fx?g(x):g(y);else if(y.fx>=h[p-1].fx){let n=!1;if(y.fx>t.fx?(K(b,1+u,v,-u,t),b.fx=e(b),b.fx<t.fx?g(b):n=!0):(K(b,1-u*c,v,u*c,t),b.fx=e(b),b.fx<y.fx?g(b):n=!0),n){if(d>=1)break;for(let t=1;t<h.length;++t)K(h[t],1-d,h[0],d,h[t]),h[t].fx=e(h[t])}}else g(y)}return h.sort(_),{fx:h[0].fx,x:h[0]}}m(fe,`nelderMead`);function pe(e,t,n,r,i,a,o){let s=n.fx,c=U(n.fxprime,t),l=s,u=s,d=c,f=0;i||=1,a||=1e-6,o||=.1;function p(u,f,p){for(let m=0;m<16;++m)if(i=(u+f)/2,K(r.x,1,n.x,i,t),l=r.fx=e(r.x,r.fxprime),d=U(r.fxprime,t),l>s+a*i*c||l>=p)f=i;else{if(Math.abs(d)<=-o*c)return i;d*(f-u)>=0&&(f=u),u=i,p=l}return 0}m(p,`zoom`);for(let m=0;m<10;++m){if(K(r.x,1,n.x,i,t),l=r.fx=e(r.x,r.fxprime),d=U(r.fxprime,t),l>s+a*i*c||m&&l>=u)return p(f,i,u);if(Math.abs(d)<=-o*c)return i;if(d>=0)return p(i,f,l);u=l,f=i,i*=2}return i}m(pe,`wolfeLineSearch`);function me(e,t,n){let r={x:t.slice(),fx:0,fxprime:t.slice()},i={x:t.slice(),fx:0,fxprime:t.slice()},a=t.slice(),o,s,c=1,l;n||={},l=n.maxIterations||t.length*20,r.fx=e(r.x,r.fxprime),o=r.fxprime.slice(),G(o,r.fxprime,-1);for(let t=0;t<l;++t){if(c=pe(e,o,r,i,c),n.history&&n.history.push({x:r.x.slice(),fx:r.fx,fxprime:r.fxprime.slice(),alpha:c}),!c)G(o,r.fxprime,-1);else{K(a,1,i.fxprime,-1,r.fxprime);let e=U(r.fxprime,r.fxprime),t=Math.max(0,U(a,i.fxprime)/e);K(o,t,o,-1,i.fxprime),s=r,r=i,i=s}if(W(r.fxprime)<=1e-5)break}return n.history&&n.history.push({x:r.x.slice(),fx:r.fx,fxprime:r.fxprime.slice(),alpha:c}),r}m(me,`conjugateGradient`);function he(e,t={}){t.maxIterations=t.maxIterations||500;let n=t.initialLayout||be,r=t.lossFunction||J,i=_e(e,t),a=n(i,t),o=Object.keys(a),s=[];for(let e of o)s.push(a[e].x),s.push(a[e].y);let c=fe(e=>{let t={};for(let n=0;n<o.length;++n){let r=o[n];t[r]={x:e[2*n],y:e[2*n+1],radius:a[r].radius}}return r(t,i)},s,t).x;for(let e=0;e<o.length;++e){let t=o[e];a[t].x=c[2*e],a[t].y=c[2*e+1]}return a}m(he,`venn`);var ge=1e-10;function q(e,t,n){return Math.min(e,t)*Math.min(e,t)*Math.PI<=n+ge?Math.abs(e-t):ue(r=>V(e,t,r)-n,0,e+t)}m(q,`distanceFromIntersectArea`);function _e(e,t={}){let n=t.distinct,r=e.map(e=>Object.assign({},e));function i(e){return e.join(`;`)}if(m(i,`toKey`),n){let e=new Map;for(let t of r)for(let n=0;n<t.sets.length;n++){let r=String(t.sets[n]);e.set(r,t.size+(e.get(r)||0));for(let i=n+1;i<t.sets.length;i++){let n=String(t.sets[i]),a=`${r};${n}`,o=`${n};${r}`;e.set(a,t.size+(e.get(a)||0)),e.set(o,t.size+(e.get(o)||0))}}for(let t of r)t.sets.length<3&&(t.size=e.get(i(t.sets)))}let a=[],o=new Set;for(let e of r)if(e.sets.length===1)a.push(e.sets[0]);else if(e.sets.length===2){let t=e.sets[0],n=e.sets[1];o.add(i(e.sets)),o.add(i([n,t]))}a.sort((e,t)=>e===t?0:e<t?-1:1);for(let e=0;e<a.length;++e){let t=a[e];for(let n=e+1;n<a.length;++n){let e=a[n];o.has(i([t,e]))||r.push({sets:[t,e],size:0})}}return r}m(_e,`addMissingAreas`);function ve(e,t,n){let r=de(t.length,t.length),i=de(t.length,t.length);return e.filter(e=>e.sets.length===2).forEach(e=>{let a=n[e.sets[0]],o=n[e.sets[1]],s=q(Math.sqrt(t[a].size/Math.PI),Math.sqrt(t[o].size/Math.PI),e.size);r[a][o]=r[o][a]=s;let c=0;e.size+1e-10>=Math.min(t[a].size,t[o].size)?c=1:e.size<=1e-10&&(c=-1),i[a][o]=i[o][a]=c}),{distances:r,constraints:i}}m(ve,`getDistanceMatrices`);function ye(e,t,n,r){for(let e=0;e<t.length;++e)t[e]=0;let i=0;for(let a=0;a<n.length;++a){let o=e[2*a],s=e[2*a+1];for(let c=a+1;c<n.length;++c){let l=e[2*c],u=e[2*c+1],d=n[a][c],f=r[a][c],p=(l-o)*(l-o)+(u-s)*(u-s),m=Math.sqrt(p),h=p-d*d;f>0&&m<=d||f<0&&m>=d||(i+=2*h*h,t[2*a]+=4*h*(o-l),t[2*a+1]+=4*h*(s-u),t[2*c]+=4*h*(l-o),t[2*c+1]+=4*h*(u-s))}}return i}m(ye,`constrainedMDSGradient`);function be(e,t={}){let n=Se(e,t),r=t.lossFunction||J;if(e.length>=8){let i=xe(e,t),a=r(i,e),o=r(n,e);a+1e-8<o&&(n=i)}return n}m(be,`bestInitialLayout`);function xe(e,t={}){let n=t.restarts||10,r=[],i={};for(let t of e)t.sets.length===1&&(i[t.sets[0]]=r.length,r.push(t));let{distances:a,constraints:o}=ve(e,r,i),s=W(a.map(W))/a.length;a=a.map(e=>e.map(e=>e/s));let c=m((e,t)=>ye(e,t,a,o),`obj`),l=null;for(let e=0;e<n;++e){let e=me(c,H(a.length*2).map(Math.random),t);(!l||e.fx<l.fx)&&(l=e)}let u=l.x,d={};for(let e=0;e<r.length;++e){let t=r[e];d[t.sets[0]]={x:u[2*e]*s,y:u[2*e+1]*s,radius:Math.sqrt(t.size/Math.PI)}}if(t.history)for(let e of t.history)G(e.x,s);return d}m(xe,`constrainedMDSLayout`);function Se(e,t){let n=t&&t.lossFunction?t.lossFunction:J,r={},i={};for(let t of e)if(t.sets.length===1){let e=t.sets[0];r[e]={x:1e10,y:1e10,rowid:r.length,size:t.size,radius:Math.sqrt(t.size/Math.PI)},i[e]=[]}e=e.filter(e=>e.sets.length===2);for(let t of e){let e=t.weight==null?1:t.weight,n=t.sets[0],a=t.sets[1];t.size+ge>=Math.min(r[n].size,r[a].size)&&(e=0),i[n].push({set:a,size:t.size,weight:e}),i[a].push({set:n,size:t.size,weight:e})}let a=[];Object.keys(i).forEach(e=>{let t=0;for(let n=0;n<i[e].length;++n)t+=i[e][n].size*i[e][n].weight;a.push({set:e,size:t})});function o(e,t){return t.size-e.size}m(o,`sortOrder`),a.sort(o);let s={};function c(e){return e.set in s}m(c,`isPositioned`);function l(e,t){r[t].x=e.x,r[t].y=e.y,s[t]=!0}m(l,`positionSet`),l({x:0,y:0},a[0].set);for(let t=1;t<a.length;++t){let s=a[t].set,d=i[s].filter(c),f=r[s];if(d.sort(o),d.length===0)throw`ERROR: missing pairwise overlap information`;let p=[];for(var u=0;u<d.length;++u){let e=r[d[u].set],t=q(f.radius,e.radius,d[u].size);p.push({x:e.x+t,y:e.y}),p.push({x:e.x-t,y:e.y}),p.push({y:e.y+t,x:e.x}),p.push({y:e.y-t,x:e.x});for(let n=u+1;n<d.length;++n){let i=r[d[n].set],a=q(f.radius,i.radius,d[n].size),o=ce({x:e.x,y:e.y,radius:t},{x:i.x,y:i.y,radius:a});p.push(...o)}}let m=1e50,h=p[0];for(let t of p){r[s].x=t.x,r[s].y=t.y;let i=n(r,e);i<m&&(m=i,h=t)}l(h,s)}return r}m(Se,`greedyLayout`);function J(e,t){let n=0;for(let r of t){if(r.sets.length===1)continue;let t;if(r.sets.length===2){let n=e[r.sets[0]],i=e[r.sets[1]];t=V(n.radius,i.radius,B(n,i))}else t=R(r.sets.map(t=>e[t]));let i=r.weight==null?1:r.weight;n+=i*(t-r.size)*(t-r.size)}return n}m(J,`lossFunction`);function Ce(e,t){let n=0;for(let r of t){if(r.sets.length===1)continue;let t;if(r.sets.length===2){let n=e[r.sets[0]],i=e[r.sets[1]];t=V(n.radius,i.radius,B(n,i))}else t=R(r.sets.map(t=>e[t]));let i=r.weight==null?1:r.weight,a=Math.log((t+1)/(r.size+1));n+=i*a*a}return n}m(Ce,`logRatioLossFunction`);function we(e,t,n){if(n==null?e.sort((e,t)=>t.radius-e.radius):e.sort(n),e.length>0){let t=e[0].x,n=e[0].y;for(let r of e)r.x-=t,r.y-=n}if(e.length===2&&B(e[0],e[1])<Math.abs(e[1].radius-e[0].radius)&&(e[1].x=e[0].x+e[0].radius-e[1].radius-1e-10,e[1].y=e[0].y),e.length>1){let n=Math.atan2(e[1].x,e[1].y)-t,r=Math.cos(n),i=Math.sin(n);for(let t of e){let e=t.x,n=t.y;t.x=r*e-i*n,t.y=i*e+r*n}}if(e.length>2){let n=Math.atan2(e[2].x,e[2].y)-t;for(;n<0;)n+=2*Math.PI;for(;n>2*Math.PI;)n-=2*Math.PI;if(n>Math.PI){let t=e[1].y/(1e-10+e[1].x);for(let n of e){var r=(n.x+t*n.y)/(1+t*t);n.x=2*r-n.x,n.y=2*r*t-n.y}}}}m(we,`orientateCircles`);function Te(e){e.forEach(e=>{e.parent=e});function t(e){return e.parent!==e&&(e.parent=t(e.parent)),e.parent}m(t,`find`);function n(e,n){let r=t(e);r.parent=t(n)}m(n,`union`);for(let t=0;t<e.length;++t)for(let r=t+1;r<e.length;++r){let i=e[t].radius+e[r].radius;B(e[t],e[r])+1e-10<i&&n(e[r],e[t])}let r=new Map;for(let n=0;n<e.length;++n){let i=t(e[n]).parent.setid;r.has(i)||r.set(i,[]),r.get(i).push(e[n])}return e.forEach(e=>{delete e.parent}),Array.from(r.values())}m(Te,`disjointCluster`);function Y(e){let t=m(t=>({max:e.reduce((e,n)=>Math.max(e,n[t]+n.radius),-1/0),min:e.reduce((e,n)=>Math.min(e,n[t]-n.radius),1/0)}),`minMax`);return{xRange:t(`x`),yRange:t(`y`)}}m(Y,`getBoundingBox`);function Ee(e,t,n){t??=Math.PI/2;let r=ke(e).map(e=>Object.assign({},e)),i=Te(r);for(let e of i){we(e,t,n);let r=Y(e);e.size=(r.xRange.max-r.xRange.min)*(r.yRange.max-r.yRange.min),e.bounds=r}i.sort((e,t)=>t.size-e.size),r=i[0];let a=r.bounds,o=(a.xRange.max-a.xRange.min)/50;function s(e,t,n){if(!e)return;let i=e.bounds,s,c;if(t)s=a.xRange.max-i.xRange.min+o;else{s=a.xRange.max-i.xRange.max;let e=(i.xRange.max-i.xRange.min)/2-(a.xRange.max-a.xRange.min)/2;e<0&&(s+=e)}if(n)c=a.yRange.max-i.yRange.min+o;else{c=a.yRange.max-i.yRange.max;let e=(i.yRange.max-i.yRange.min)/2-(a.yRange.max-a.yRange.min)/2;e<0&&(c+=e)}for(let t of e)t.x+=s,t.y+=c,r.push(t)}m(s,`addCluster`);let c=1;for(;c<i.length;)s(i[c],!0,!1),s(i[c+1],!1,!0),s(i[c+2],!0,!0),c+=3,a=Y(r);return Oe(r)}m(Ee,`normalizeSolution`);function De(e,t,n,r,i){let a=ke(e);t-=2*r,n-=2*r;let{xRange:o,yRange:s}=Y(a);if(o.max===o.min||s.max===s.min)return console.log(`not scaling solution: zero size detected`),e;let c,l;if(i){let e=Math.sqrt(i/Math.PI)*2;c=t/e,l=n/e}else c=t/(o.max-o.min),l=n/(s.max-s.min);let u=Math.min(l,c),d=(t-(o.max-o.min)*u)/2,f=(n-(s.max-s.min)*u)/2;return Oe(a.map(e=>({radius:u*e.radius,x:r+d+(e.x-o.min)*u,y:r+f+(e.y-s.min)*u,setid:e.setid})))}m(De,`scaleSolution`);function Oe(e){let t={};for(let n of e)t[n.setid]=n;return t}m(Oe,`toObjectNotation`);function ke(e){return Object.keys(e).map(t=>Object.assign(e[t],{setid:t}))}m(ke,`fromObjectNotation`);function Ae(e={}){let t=!1,n=600,r=350,i=15,a=1e3,o=Math.PI/2,s=!0,c=null,l=!0,u=!0,d=null,f=null,p=!1,h=null,g=e&&e.symmetricalTextCentre?e.symmetricalTextCentre:!1,_={},v=e&&e.colourScheme?e.colourScheme:e&&e.colorScheme?e.colorScheme:[`#1f77b4`,`#ff7f0e`,`#2ca02c`,`#d62728`,`#9467bd`,`#8c564b`,`#e377c2`,`#7f7f7f`,`#bcbd22`,`#17becf`],y=0,b=m(function(e){if(e in _)return _[e];var t=_[e]=v[y];return y+=1,y>=v.length&&(y=0),t},`colours`),x=he,S=J;function C(_){let v=_.datum(),y=new Set;v.forEach(e=>{e.size==0&&e.sets.length==1&&y.add(e.sets[0])}),v=v.filter(e=>!e.sets.some(e=>y.has(e)));let C={},w={};if(v.length>0){let e=x(v,{lossFunction:S,distinct:p});s&&(e=Ee(e,o,f)),C=De(e,n,r,i,c),w=Ne(C,v,g)}let T={};v.forEach(e=>{e.label&&(T[e.sets]=e.label)});function E(e){if(e.sets in T)return T[e.sets];if(e.sets.length==1)return``+e.sets[0]}m(E,`label`),_.selectAll(`svg`).data([C]).enter().append(`svg`);let D=_.select(`svg`);t?D.attr(`viewBox`,`0 0 ${n} ${r}`):D.attr(`width`,n).attr(`height`,r);let O={},k=!1;D.selectAll(`.venn-area path`).each(function(e){let t=this.getAttribute(`d`);e.sets.length==1&&t&&!p&&(k=!0,O[e.sets[0]]=Fe(t))});function A(e){return t=>Q(e.sets.map(e=>{let i=O[e],a=C[e];return i||={x:n/2,y:r/2,radius:1},a||={x:n/2,y:r/2,radius:1},{x:i.x*(1-t)+a.x*t,y:i.y*(1-t)+a.y*t,radius:i.radius*(1-t)+a.radius*t}}),h)}m(A,`pathTween`);let j=D.selectAll(`.venn-area`).data(v,e=>e.sets),M=j.enter().append(`g`).attr(`class`,e=>`venn-area venn-${e.sets.length==1?`circle`:`intersection`}${e.colour||e.color?` venn-coloured`:``}`).attr(`data-venn-sets`,e=>e.sets.join(`_`)),ee=M.append(`path`),N=M.append(`text`).attr(`class`,`label`).text(e=>E(e)).attr(`text-anchor`,`middle`).attr(`dy`,`.35em`).attr(`x`,n/2).attr(`y`,r/2);u&&(ee.style(`fill-opacity`,`0`).filter(e=>e.sets.length==1).style(`fill`,e=>e.colour?e.colour:e.color?e.color:b(e.sets)).style(`fill-opacity`,`.25`),N.style(`fill`,t=>t.colour||t.color?`#FFF`:e.textFill?e.textFill:t.sets.length==1?b(t.sets):`#444`));function P(e){return typeof e.transition==`function`?e.transition(`venn`).duration(a):e}m(P,`asTransition`);let F=_;k&&typeof F.transition==`function`?(F=P(_),F.selectAll(`path`).attrTween(`d`,A)):F.selectAll(`path`).attr(`d`,e=>Q(e.sets.map(e=>C[e])),h);let I=F.selectAll(`text`).filter(e=>e.sets in w).text(e=>E(e)).attr(`x`,e=>Math.floor(w[e.sets].x)).attr(`y`,e=>Math.floor(w[e.sets].y));l&&(k?`on`in I?I.on(`end`,X(C,E)):I.each(`end`,X(C,E)):I.each(X(C,E)));let L=P(j.exit()).remove();typeof j.transition==`function`&&L.selectAll(`path`).attrTween(`d`,A);let te=L.selectAll(`text`).attr(`x`,n/2).attr(`y`,r/2);return d!==null&&(N.style(`font-size`,`0px`),I.style(`font-size`,d),te.style(`font-size`,`0px`)),{circles:C,textCentres:w,nodes:j,enter:M,update:F,exit:L}}return m(C,`chart`),C.wrap=function(e){return arguments.length?(l=e,C):l},C.useViewBox=function(){return t=!0,C},C.width=function(e){return arguments.length?(n=e,C):n},C.height=function(e){return arguments.length?(r=e,C):r},C.padding=function(e){return arguments.length?(i=e,C):i},C.distinct=function(e){return arguments.length?(p=e,C):p},C.colours=function(e){return arguments.length?(b=e,C):b},C.colors=function(e){return arguments.length?(b=e,C):b},C.fontSize=function(e){return arguments.length?(d=e,C):d},C.round=function(e){return arguments.length?(h=e,C):h},C.duration=function(e){return arguments.length?(a=e,C):a},C.layoutFunction=function(e){return arguments.length?(x=e,C):x},C.normalize=function(e){return arguments.length?(s=e,C):s},C.scaleToFit=function(e){return arguments.length?(c=e,C):c},C.styled=function(e){return arguments.length?(u=e,C):u},C.orientation=function(e){return arguments.length?(o=e,C):o},C.orientationOrder=function(e){return arguments.length?(f=e,C):f},C.lossFunction=function(e){return arguments.length?(S=e===`default`?J:e===`logRatio`?Ce:e,C):S},C}m(Ae,`VennDiagram`);function X(e,t){return function(n){let r=this,i=e[n.sets[0]].radius||50,a=t(n)||``,o=a.split(/\s+/).reverse(),s=(a.length+o.length)/3,c=o.pop(),l=[c],u=0,d=1.1;r.textContent=null;let f=[];function p(e){let t=r.ownerDocument.createElementNS(r.namespaceURI,`tspan`);return t.textContent=e,f.push(t),r.append(t),t}m(p,`append`);let h=p(c);for(;c=o.pop(),c;){l.push(c);let e=l.join(` `);h.textContent=e,e.length>s&&h.getComputedTextLength()>i&&(l.pop(),h.textContent=l.join(` `),l=[c],h=p(c),u++)}let g=.35-u*d/2,_=r.getAttribute(`x`),v=r.getAttribute(`y`);f.forEach((e,t)=>{e.setAttribute(`x`,_),e.setAttribute(`y`,v),e.setAttribute(`dy`,`${g+t*d}em`)})}}m(X,`wrapText`);function Z(e,t,n){let r=t[0].radius-B(t[0],e);for(let n=1;n<t.length;++n){let i=t[n].radius-B(t[n],e);i<=r&&(r=i)}for(let t=0;t<n.length;++t){let i=B(n[t],e)-n[t].radius;i<=r&&(r=i)}return r}m(Z,`circleMargin`);function je(e,t,n){let r=[];for(let t of e)r.push({x:t.x,y:t.y}),r.push({x:t.x+t.radius/2,y:t.y}),r.push({x:t.x-t.radius/2,y:t.y}),r.push({x:t.x,y:t.y+t.radius/2}),r.push({x:t.x,y:t.y-t.radius/2});let i=r[0],a=Z(r[0],e,t);for(let n=1;n<r.length;++n){let o=Z(r[n],e,t);o>=a&&(i=r[n],a=o)}let o=fe(n=>-1*Z({x:n[0],y:n[1]},e,t),[i.x,i.y],{maxIterations:500,minErrorDelta:1e-10}).x,s={x:n?0:o[0],y:o[1]},c=!0;for(let t of e)if(B(s,t)>t.radius){c=!1;break}for(let e of t)if(B(s,e)<e.radius){c=!1;break}if(c)return s;if(e.length==1)return{x:e[0].x,y:e[0].y};let l={};return R(e,l),l.arcs.length===0?{x:0,y:-1e3,disjoint:!0}:l.arcs.length==1?{x:l.arcs[0].circle.x,y:l.arcs[0].circle.y}:t.length?je(e,[]):le(l.arcs.map(e=>e.p1))}m(je,`computeTextCentre`);function Me(e){let t={},n=Object.keys(e);for(let e of n)t[e]=[];for(let r=0;r<n.length;r++){let i=n[r],a=e[i];for(let o=r+1;o<n.length;++o){let r=n[o],s=e[r],c=B(a,s);c+s.radius<=a.radius+1e-10?t[r].push(i):c+a.radius<=s.radius+1e-10&&t[i].push(r)}}return t}m(Me,`getOverlappingCircles`);function Ne(e,t,n){let r={},i=Me(e);for(let a=0;a<t.length;++a){let o=t[a].sets,s={},c={};for(let e=0;e<o.length;++e){s[o[e]]=!0;let t=i[o[e]];for(let e=0;e<t.length;++e)c[t[e]]=!0}let l=[],u=[];for(let t in e)t in s?l.push(e[t]):t in c||u.push(e[t]);let d=je(l,u,n);r[o]=d,d.disjoint&&t[a].size>0&&console.log(`WARNING: area `+o+` not represented on screen`)}return r}m(Ne,`computeTextCentres`);function Pe(e,t,n){let r=[];return r.push(`
M`,e,t),r.push(`
m`,-n,0),r.push(`
